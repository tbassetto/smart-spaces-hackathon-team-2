 ...
 * @class
 */
var User = _sparkCore.SparkPlugin.extend((_dec = (0, _sparkCore.waitForValue)('@'), _dec2 = (0, _common.oneFlight)({ keyFactory: function keyFactory(email, options) {
    return email + String(options && options.create);
  } }), _dec3 = (0, _sparkCore.persist)('@'), _dec4 = (0, _common.deprecated)('Use User#verify()'), (_obj = {
  namespace: 'User',
  ...
  activate: function activate() {
    ...
    return this.getUserCI(options.email, needsCILookup).then(function () {
      ...
      return _this.request({
        ...
        _this.spark.credentials.set({ supertoken: res.body.tokenData });
        return res.body;
      });
    });
  },
  ...
  initialize: function initialize() {
    ...
    return (0, _apply2.default)(_sparkCore.SparkPlugin.prototype.initialize, this, args);
  },
