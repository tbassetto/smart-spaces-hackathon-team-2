...
var DryError = exports.DryError = (_temp2 = _class2 = function (_SparkHttpError) {
  (0, _inherits3.default)(DryError, _SparkHttpError);
  ...
  (0, _createClass3.default)(DryError, [{
    ...
    value: function parse(reason) {
      (0, _apply2.default)(_sparkCore.SparkHttpError.prototype.parse, this, [reason._res]);
  ...
  return DryError;
}(_sparkCore.SparkHttpError), _class2.defaultMessage = 'An unknown error was received from a service that proxies to the KMS', _temp2);
